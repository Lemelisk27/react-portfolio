    ...
    if (currentState) {
        return (
            ...
            <div className="d-flex flex-column col-lg-4 col-11 bg-secondary px-auto my-2 mx-2 justify-content-center align-items-center" onMouseEnter={toggleHover} onMouseLeave={toggleHover}>
                <a href={props.projects.site} className="text-decoration-none" target="_blank" rel='noreferrer noopener'>
                    <h2 className="d-flex col-12 zs-hover">{props.projects.title}</h2>
                </a>
